...
int main(int argc, char** argv) {
    ...
    */
    ...
    d.agregar(std::string("juan"), std::string("ala si muchissss!!"));
    d.agregar(std::string("diego"), std::string("sus"));
    d.agregar(std::string("sofia"), std::string("waluigi"));
    d.agregar(std::string("ernesto rodriguez pfister"), std::string("Estimadisimo catedratico de la materia Informatica II"));
    d.agregar(std::string("col"), std::string("verdura deliciosa hecha de hojas"));
    d.agregar(std::string("consejo"), std::string("reunion de los miembros de un consejo"));
    d.agregar(std::string("concejo"), std::string("definicion equivocada"));

    d.agregar(std::string("concejo"), std::string("sesion celebrada por los individuos de un concejo"));
    ...
    */
    ...
    while(palabra != std::string("")) {
        std::cout << "Palabra " << palabra << " empieza con letra 'c' \n";
